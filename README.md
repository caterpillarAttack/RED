# Project RED
Second Life Client Modifications
...
- **Shader Side:** Currently there are three shader classes for different hardware spec, some of it very ancient, and I intend to do some pruning to simplify the amount of code that needs to be maintained.
...
- **Overall:** Figure out how to implement a better texture caching system, as the current one if I understand it correctly, has to decompress a texture from JPEG2000 and send it to the card every time its loaded.
